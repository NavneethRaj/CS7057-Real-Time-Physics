...
#define DAMPING 100.0f // how much to damp the cloth simulation each frame
#define TIME_STEPSIZE2 500.0f*500.0f // how large time step each particle takes each frame
...
void display(void)
{
	...
	ball_time++;
	ball_pos[2] = (float)cos(ball_time/25.0f)*7;
